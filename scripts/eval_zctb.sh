...
python ./scripts/gold_order_sents.py ./ctb/best_pred_test.conllx ./ctb/ZHA-GOLD-ORDER > ./ctb/pred_test.conllx.ordered 
paste ./ctb/pred_test.conllx.ordered ./ctb/ZHA-GOLD-WORDS ./ctb/zha_predicted_unaries_test > ./ctb/tmp
...
./scripts/EVALB/evalb -p ./scripts/EVALB/COLLINS.prm  ./ctb/ZHA-GOLD-TEST.trees  ./ctb/pred_test.trees
