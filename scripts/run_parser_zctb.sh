...
python scripts/L2RParser.py --mode FastLSTM --num_epochs 1000 --batch_size 32 --decoder_input_size 256 --hidden_size 512 --encoder_layers 3 --decoder_layers 1 \
 ...
 --p_in 0.33 --p_out 0.33 --p_rnn 0.33 0.33 --unk_replace 0.5 --label_smooth 1.0 --char --pos --beam 10 --prior_order inside_out \
 --word_embedding sskip --word_path "embs/sskip.ch.gz" --char_embedding random \
 --punctuation 'PU' \
 --train "data/zha-train.aug.conllx" \
 --dev "data/zha-dev.aug.conllx" \
 --test "data/zha-test.aug.conllx" \
 --model_path "models/"$1"/" --model_name 'network.pt' --proj
