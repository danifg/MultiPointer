...
python scripts/L2RParser.py --mode FastLSTM --num_epochs 1000 --batch_size 32 --decoder_input_size 256 --hidden_size 512 --encoder_layers 3 --decoder_layers 1 \
 ...
 --punctuation '.' '``' "''" ':' ',' \
 --train "data/tiger_spmrl_train.aug.conllx" \
 --dev "data/tiger_spmrl_dev.aug.conllx" \
 --test "data/tiger_spmrl_test.aug.conllx" \
 --model_path "models/"$1"/" --model_name 'network.pt'
