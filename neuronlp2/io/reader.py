...
class CoNLLXReader(object):
    def __init__(self, file_path, word_alphabet, char_alphabet, pos_alphabet, type_alphabet, ctype_alphabet):
        self.__source_file = open(file_path, 'r')
        self.__word_alphabet = word_alphabet
        self.__char_alphabet = char_alphabet
        self.__pos_alphabet = pos_alphabet
        self.__type_alphabet = type_alphabet
        self.__ctype_alphabet = ctype_alphabet
    ...
    def getNext(self, normalize_digits=True, symbolic_root=False, symbolic_end=False):
        ...
        if symbolic_root:
            ...
            heads.append(0)
            ctypes.append(ROOT_TYPE)
            ctype_ids.append(self.__ctype_alphabet.get_index(ROOT_TYPE)) 
            cheads.append(0)
        ...
        for tokens in lines:
            ...
            ctypes.append(ctype)
            ctype_ids.append(self.__ctype_alphabet.get_index(ctype))
        ...
        if symbolic_end:
            ...
            heads.append(0)
            ctypes.append(END_TYPE)
            ctype_ids.append(self.__ctype_alphabet.get_index(END_TYPE))
            cheads.append(0)

        return DependencyInstance(Sentence(words, word_ids, char_seqs, char_id_seqs), postags, pos_ids, heads, types, type_ids, cheads, ctypes, ctype_ids)
